...
**Examples:**
- User asks about billing → `set_chat_title.py "Green Diamond Billing Setup"`
...
/home/david/Work/hivematrix/hivematrix-brainhair/ai_tools/set_chat_title.py "Green Diamond Billing"
```
